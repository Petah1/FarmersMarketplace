...
- [x] 5. Run `npm test` in backend/ to verify all tests pass
- [ ] 6. Commit changes with message "Fix grade filter bug in products.js, add grade column + tests"
- [ ] 7. Push branch and create PR to main via `gh pr create`
